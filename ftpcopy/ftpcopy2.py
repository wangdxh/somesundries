...
def main():
    '''main'''
    ftppathput, ipftpput = 'serverread', '172.16.118.206'
    ftppathget, ipftpget = 'clientwrite', '172.16.251.98'
    temppath = './temppath2/'
    ...
    print ftpput.login('zjq', 'kedacom123')
    print ftpget.login('ftptest', 'kedacom123')
